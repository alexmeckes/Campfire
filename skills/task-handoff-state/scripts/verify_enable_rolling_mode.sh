...
expect_contains "$TASK_DIR/checkpoints.json" '"max_milestones_per_run": 2'
...
expect_contains "$TASK_DIR/handoff.md" 'auto-advance through the queued milestones'
...
expect_contains /tmp/campfire_enable_resume.out 'auto-advance through queued milestones'
